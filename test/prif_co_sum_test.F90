  ...
  function results() result(test_results)
    ...
    type(prif_co_sum_test_t) prif_co_sum_test
      ...
      test_results = prif_co_sum_test%run([ &
         test_description_t("computing the element-wise sum of a 1D default integer array", bless(check_default_integer)) &
        ,test_description_t("computing the element-wise sum of a 1D 8-bit integer(c_int8_t) array", bless(check_8_bit_integer)) &
        ,test_description_t("computing the element-wise sum of a 1D 16-bit integer(c_int16_t) array", bless(check_16_bit_integer)) &
        ,test_description_t("computing the element-wise sum of integer(c_int32_t) scalars", bless(check_32_bit_integer)) &
        ,test_description_t("computing the element-wise sum of a 1D 64-bit integer(c_int64_t) array", bless(check_64_bit_integer)) &
        ,test_description_t("computing the element-wise sum of a 2D 32-bit real(c_float) array", bless(check_32_bit_real)) &
        ,test_description_t("computing the element-wise sum of a 1D 64-bit real(c_double) array", bless(check_64_bit_real)) &
        ,test_description_t("computing the element-wise sum of a 2D complex(c_float) array", bless(check_32_bit_complex)) &
        ,test_description_t("computing the element-wise sum of a 1D complex(c_double) array", bless(check_64_bit_complex)) &
      ])
  end function
