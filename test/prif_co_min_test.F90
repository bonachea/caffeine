...
contains
  ...
  function results() result(test_results)
    ...
    test_results = prif_co_min_test%run([ &
       test_description_t("computing element-wise minima for integer(c_int32_t) scalars", bless(check_32_bit_integer)) &
      ,test_description_t("computing element-wise minima for a 1D default integer array", bless(check_default_integer)) &
      ,test_description_t("computing element-wise minima for a 1D integer(c_int8t) array", bless(check_8_bit_integer)) &
      ,test_description_t("computing element-wise minima for a 1D integer(c_int16_t) array", bless(check_16_bit_integer)) &
      ,test_description_t("computing element-wise minima for a 1D integer(c_int64_t) array", bless(check_64_bit_integer)) &
      ,test_description_t("computing element-wise minima for a 2D real(c_float) array", bless(check_32_bit_real)) &
      ,test_description_t("computing element-wise minima for a 1D real(c_double) array", bless(check_64_bit_real)) &
      ,test_description_t("computing element-wise minima for a character scalar", bless(check_character)) &
    ])
  end function
